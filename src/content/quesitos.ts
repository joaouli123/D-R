...
// ============================================================
// MÓDULO K — Banco de Quesitos pré-cadastrados (item 17)
// O perito seleciona os quesitos aplicáveis ao caso, responde,
// edita livremente e exporta o documento.
// ============================================================
...
const q = (
  ...
  seq += 1
  return {
    id: `qst-${String(seq).padStart(3, '0')}`,
...
export const TEMAS_QUESITO: { value: Quesito['tema']; label: string }[] = [
  ...
  { value: 'quimicos', label: 'Agentes Químicos' },
  { value: 'biologicos', label: 'Agentes Biológicos' },
  { value: 'epi', label: 'EPI' },
...
export const ORIGENS_QUESITO: { value: Quesito['origem']; label: string }[] = [
  { value: 'juizo', label: 'Do Juízo' },
  { value: 'reclamante', label: 'Do Reclamante' },
  { value: 'reclamada', label: 'Da Reclamada' },
  { value: 'proprio', label: 'Do Perito' },
]
