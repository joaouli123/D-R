...
const SUBSTANCIAS_FONTE: readonly SubstanciaFonte[] = [
  ...
  { id: 'CLOPRENE', label: 'Cloroprene', ppm: '20', mgM3: '70', grau: 'maximo', absorcaoPele: true },
  ...
  { id: 'OXIDO_NITROSO', label: 'Óxido nitroso (N₂O)', grau: 'nao_caracterizado', asfixianteSimples: true },
